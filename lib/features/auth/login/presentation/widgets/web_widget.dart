...
class _WebLoginPageState extends State<WebLoginPage> {
                    ...
                    children: [
                      ...
                      if (email.text.isNotEmpty)
                        Padding(
                          ...
                          child: Text(
                            Validators.getUsernameError(email.text) ?? '',
                            style: TextStyle(
                              color: Validators.getUsernameError(email.text) == null ? Colors.green : Colors.red,
                              fontSize: 12,
                            ),
                          ),
                        ),
  ...
  bool _validateFields(BuildContext context) {
    ...
    String? usernameError = Validators.getUsernameError(email.text);
